...
recipe = [
  Ingredient("chicken-stock", 1500, INGREDIENT_CAT.OTHER),
...
5. Half bok choy.
   In noodle water, cook bok choy for about 1minute until tender
   Add bok choy to serving bowls
6. Ladle some broth to serving bowl. 
   Mix in paste from bottom of bowl.
   Add more broth
7. Top with chicken mince and extra spring onion.
(Boil eggs by swirling to have yolk in centre)
