...
global_recipes = [
  ...
  R("beef-massaman", "beef", "rice", 3,
    [I("red-onion", 1, "fruit-veg"),
     ...
     I("coriander", 2, "fruit-veg"),
     I("cumin", 2, "other"),
     I("cinnamon", 0.5, "other"),
     I("white-pepper", 0.5, "other"),
     I("garlic", 3, "fruit-veg"),
  ...
  R("butter-chicken", "chicken", "rice", 2,
    [I("chicken-breast", 700, "meat"),
     ...
     I("garam-masala", 2.5, "other"),
     I("coriander", 1, "other"),
     I("paprika", 2, "other"),
     I("chilli-powder", 1, "other"),
     I("brown-onion", 1, "fruit-veg"),
     I("ginger", 2, "fruit-veg"),
     I("curry-powder", 1, "other"),
     I("cinnamon", 0.5, "other"),
