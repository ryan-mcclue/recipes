...
recipe = [
  ...
  Ingredient("macaroni", 500, INGREDIENT_CAT.OTHER),
  ...
  Ingredient("potato", 2, INGREDIENT_CAT.FRUIT_VEG),
  Ingredient("lentils", 1, INGREDIENT_CAT.OTHER),
  Ingredient("parmesan", 1, INGREDIENT_CAT.DAIRY),
  Ingredient("chicken-stock", 4, INGREDIENT_CAT.OTHER),
...
5. Cook pasta in separate pot
   Serve pasta then top with broth.
    ...
    10 cups Chicken Broth (4 cups chicken, 2 cups water)
    1 1/2 cups French Green Lentils (1 can)
    1 lb. Hot Italian Pork Sausage, casings removed (500g)
    3 Carrots, peeled and chopped (2)
    4 Celery Ribs, chopped (3)
    1 Small Yellow Onion, chopped 
    5 Golden Yukon Potatoes, cubed (2)
    4 Sprigs of Thyme
    1 Bay Leaf
    Handful of Parsley, chopped for topping
    1 cup Tubeti (half packet of macaroni)
