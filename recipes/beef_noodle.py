...
recipe = [
  ...
  Ingredient("tomatoes", 1, INGREDIENT_CAT.FRUIT_VEG),
  Ingredient("soy-sauce", 4, INGREDIENT_CAT.OTHER),
  Ingredient("chinese-wine", 4, INGREDIENT_CAT.OTHER),
  Ingredient("pickled-mustard-greens", 1, INGREDIENT_CAT.OTHER),
  Ingredient("noodles", 400, INGREDIENT_CAT.OTHER),
] 
'''
1. Cube meat. Place in boiling water for 2-3minutes. 
   Remove and set aside
2. Meanwhile, roast spice bag spices for a few minutes.
   Place in bag.
3. When oil hot, add onion wedges, crushed garlic cloves, ginger slices and batoned spring onions.
4. Add tomato wedges and meat.
5. Add tomato paste, chilli bean paste, chinese wine, soy sauce, 1/2water-1/2beefstock.
6. Add spice bag and 3 dates, scraping up bits off bottom of pan.
7. Meat/stew setting for 60minutes.
8. Strain broth.
9. Serve with noodles, bok choy, meat pieces and then add broth.
